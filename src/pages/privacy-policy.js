    ...
    <div className="privacy-policy-area ptb-100">
      <div className="container">
        <div className="privacy-policy-content">
          ...
          <p>
            Hi there, we’re <strong>Timo</strong>, and welcome to our privacy
            policy which also applies to our customers.
          </p>

          <p>
            This policy sets out how we handle your personal information if
            you’re an <strong>Timo</strong> user or visitor to our site.
          </p>

          <p>
            When we say ‘we’, ‘us’, or <strong>‘Timo’</strong>, it’s because
          ...
          <p>
            ...
            <b>customer/subscriber</b> and deliver products/information and
            other marketing elements. Visitors aren’t allowed to purchase any
            product or subscribe to the newsletter or make a comment
            anonymously. So, this information is the only means we can identify
            you and allow you to make these actions on the site.
          </p>
          ...
          <p>
            ...
            laws and regulations). Only our <i>authorities</i> have access to
            your data and no third-party access to your data from us.
          </p>
          ...
          <p>
            ...
            visitors’ IP and time of visits. <strong>Timo</strong> visitors who
            do not wish to have cookies placed on their browsers should set
            their browsers to refuse cookies before using the{" "}
            <strong>Timo</strong> site.
          </p>
          ...
          <p>
            ...
            information or to provide you with the <strong>Timo</strong>{" "}
          ...
          <p>
            ...
            our support at <a href="mailto:hello@timo.com">hello@timo.com</a>.
          </p>
          <p>
