...
import shapeImg from "../../images/shape/shape12.png"

const HowItWorksStyle2 = () => {
  return (
    <>
      <div id="howItWorks" className="core-features-area ptb-100 position-relative z-index1 bg-f6f5f0">
        <Container>
        ...
        <div className="shapes">
          <img src={shapeImg} alt="shape12" className="shape12" />
        </div>
      </div>
    </>
  )
